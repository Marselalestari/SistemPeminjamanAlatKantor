...
<div>
    ...
    <input
        ...
        maxlength="16"
        class="w-full bg-gray-50 border rounded-2xl px-4 py-3 text-gray-900 focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 focus:outline-none transition-all {{ $errors->has('nik') ? 'border-red-500' : 'border-gray-200' }}"
        required
    >
